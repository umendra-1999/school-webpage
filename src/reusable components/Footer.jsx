    ...
    <>
      <footer className="bg-black text-white border-t-4 border-black">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:w-2/3 justify-end">
        ...
        <div className="bg-black border-t border-black mt-6 py-4">
          <div className="flex flex-col md:flex-row justify-center gap-6 items-center">
            <p className="bg-black text-red-700 border-2 hover:scale-95 transition-transform border-white rounded p-3 font-semibold">
